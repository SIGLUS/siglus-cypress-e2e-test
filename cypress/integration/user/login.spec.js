describe('login test',() =>{
        ...
        it('login successfully and then log out', () => {
            ...
            cy.get('.home-page > :nth-child(2)')
                .should('contain','Welcome to OpenLMIS Mozambique')
            cy.get('.system-notification-list > h2.ng-binding')
                .should('contain','System Notification')
